...
export default function Sidebar() {
  ...
  const { profilePanel, setProfilePanel } = useContext(ClientContext);

  return (
    <div className={profilePanel ? 'fixed left-[-100%] ' :'fixed left-0 top-0 w-[20%] h-full border-r border-r-white bg-[#fafffa] ease-in-out duration-300 z-20'}>
        ...
        <div className="w-full h-[250px] bg-[#4bb6b7]" >
          ...
          <div className='p-4'>
            ...
            <div className='flex flex-row-2 text-white'>
              ...
              <div className='hover:text-black' onClick={() => setProfilePanel(!profilePanel)}>
