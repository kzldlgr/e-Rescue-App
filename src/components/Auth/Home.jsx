        ...
        <div className="overlay-container">
          <div className="overlay">
            ...
            <div className="overlay-panel overlay-right">
              <h1 className="text-5xl leading-10 m-0 drop-shadow-lg text-[#4bb6b7]">Hello there</h1>
              <p className='my-6'>Having troubles or emergencies? Use e-Rescue now to get help anywhere you are.</p>
